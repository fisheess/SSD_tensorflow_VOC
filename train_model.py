...
class TrainModel(PrepareData):
    def __init__(self):
        ...
        self.save_interval_secs = 60 * 30  # half hour
    ...
    def setup_debugging(self, predictions, localizations, glabels, gbboxes, gdifficults):
        ...
        _, self.mAP_12_op_train = g_post_processing_data.get_mAP_tf_current_batch(predictions, localizations, glabels,
                                                                                  gbboxes, gdifficults)
        return
    ...
    def run(self):
        ...
        self.train_dir = './512logs'

        # self.checkpoint_path = '../data/trained_models/vgg16/vgg_16.ckpt'
        self.checkpoint_path = '/home/yjin/SSD-Tensorflow/checkpoints/vgg_16.ckpt'
        ...
        if self.fine_tune_vgg16:
            ...
            self.train_dir = './512logs/finetune'
            self.checkpoint_path = './512logs/finetune'
            self.checkpoint_exclude_scopes = None
